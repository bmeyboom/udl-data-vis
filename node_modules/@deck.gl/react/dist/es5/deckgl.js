...
var DeckGL = (0, _react.forwardRef)(function (props, ref) {
  ...
  var updateFromProps = function updateFromProps() {
    if (!thisRef.deck) {
      return;
    }

    var deckProps = _objectSpread(_objectSpread({}, props), {}, {
      style: null,
      width: '100%',
      height: '100%',
  ...
  (0, _react.useEffect)(function () {
    thisRef.deck = createDeckInstance(thisRef, _objectSpread(_objectSpread({}, props), {}, {
  ...
  if (!thisRef.control || !thisRef.viewStateUpdateRequested && thisRef.lastRenderedViewports === currentViewports || thisRef.redrawReason) {
