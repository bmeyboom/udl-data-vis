  ...
  (0, _createClass2.default)(MVTLayer, [{
    ...
    value: function () {
      var _updateTileData2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee() {
        var _this$props, data, minZoom, maxZoom, tileJSON, _this$props2, onDataLoad, fetch;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props = this.props, data = _this$props.data, minZoom = _this$props.minZoom, maxZoom = _this$props.maxZoom;
                tileJSON = null;
                ...
                _this$props2 = this.props, onDataLoad = _this$props2.onDataLoad, fetch = _this$props2.fetch;
                this.setState({
                  data: null,
                  tileJSON: null
                });
    ...
    value: function getHighlightedObjectIndex(tile) {
      ...
      var _this$props4 = this.props,
          uniqueIdProperty = _this$props4.uniqueIdProperty,
          highlightedFeatureId = _this$props4.highlightedFeatureId,
          binary = _this$props4.binary;
      var data = tile.data;
      ...
      if (Array.isArray(data)) {
        ...
        var featureIdIndex = (0, _layers._findIndexBinary)(data, uniqueIdProperty, featureIdToHighlight);
