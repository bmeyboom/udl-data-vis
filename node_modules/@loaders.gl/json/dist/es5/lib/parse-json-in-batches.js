...
function _parseJSONInBatches() {
  _parseJSONInBatches = (0, _wrapAsyncGenerator2["default"])(_regenerator["default"].mark(function _callee(asyncIterator, options) {
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            asyncIterator = (0, _loaderUtils.makeTextDecoderIterator)(asyncIterator);
