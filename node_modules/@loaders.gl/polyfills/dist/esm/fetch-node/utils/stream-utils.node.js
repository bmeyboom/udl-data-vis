        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return new Promise(function (resolve, reject) {
              var stream = fs.createReadStream(noqueryUrl, {
                encoding: null
              });
          ...
          case 5:
            _context.next = 7;
            return new Promise(function (resolve, reject) {
              var requestFunction = url.startsWith('https:') ? https.request : http.request;
...
export function concatenateReadStream(_x3) {
  return _concatenateReadStream.apply(this, arguments);
}

function _concatenateReadStream() {
  _concatenateReadStream = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(readStream) {
    var arrayBuffer;
          ...
          case 0:
            ...
            return new Promise(function (resolve, reject) {
              ...
              readStream.on('data', function (chunk) {
                ...
                var chunkAsArrayBuffer = toArrayBuffer(chunk);
